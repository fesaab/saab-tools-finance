...
public class NedbankTransactionParser implements TransactionParser {
    ...
    public NedbankTransactionParser() {
        this(null, null, null);
    }

    public NedbankTransactionParser(CategoryMappingRepository categoryMappingRepository) {
        this(null, null, categoryMappingRepository);
    }

    public NedbankTransactionParser(ObjectMapper objectMapper, CategoryMapper categoryMapper, CategoryMappingRepository categoryMappingRepository) {
